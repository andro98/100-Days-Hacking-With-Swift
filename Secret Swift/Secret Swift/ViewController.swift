...
//  Secret Swift
//
//  Created by Andrew Maher on 10/11/20.
...
//        unloackSecretMessage()
    ...
    func unloackSecretMessage(){
        secret.isHidden = false
        title = "Secret stuff!"
        
        secret.text = KeychainWrapper.stringForKey(keyName: "SecretMessage") ?? ""
    }
    
    @objc func saveSecretMessage(){
        guard secret.isHidden == false else {return}
        KeychainWrapper.setString(value: secret.text, forKey: "SecretMessage")
